    ...
    <div>
        ...
        <div class="relative mt-1">
            ...
            <input id="bid_value" type="number" min="0" step="1" name="value" value="{{ $val('value') }}"
                class="block w-full rounded-xl border border-gray-300 bg-white px-3 py-2 pl-8 text-sm text-gray-900 shadow-sm
                       focus:border-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-300
                       dark:border-gray-700 dark:bg-gray-950 dark:text-gray-100 dark:focus:border-indigo-400 dark:focus:ring-indigo-500" placeholder="Enter your bid" />
        </div>
    ...
    <div class="flex items-center justify-end gap-3">
        <a href="{{ url()->previous() }}"
            class="inline-flex items-center rounded-lg border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-800
                   ...
                   dark:border-gray-600 dark:bg-gray-900 dark:text-gray-100 dark:hover:bg-gray-800 dark:focus:ring-gray-600">
            Cancel
        </a>

        <button type="submit" class="inline-flex items-center rounded-lg bg-indigo-600 px-4 py-2 text-sm font-medium text-white
                   hover:bg-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-400
                   dark:bg-indigo-500 dark:hover:bg-indigo-400 dark:focus:ring-indigo-300">
            {{ $submitLabel }}
        </button>
    </div>
</form>